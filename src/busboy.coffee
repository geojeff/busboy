# busboy.coffee
#
# The code blocks below are from the uploading branch of Thoth, where thumbnailing
# was added, using node-imagemagick and node-canvas. busboy development will start
# from here, but there is more to consider in the node.js and maybe even python
# worlds...
#
